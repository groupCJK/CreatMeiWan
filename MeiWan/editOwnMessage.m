...
@interface editOwnMessage ()<UITextViewDelegate,MBProgressHUDDelegate>
{
    UITextView * textview;
    MBProgressHUD * HUD;
}
...
- (void)saveButton:(UIButton *)sender
{
    ...
    [HUD showAnimated:YES whileExecutingBlock:^{
        ...
        NSMutableDictionary * dic = [[NSMutableDictionary alloc]initWithObjectsAndKeys:textview.text,@"nickname", nil];
